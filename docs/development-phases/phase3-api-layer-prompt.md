...
🧱 1️⃣ Create app/api/middleware.py
...
🧱 3️⃣ Implement Routers (Async + DI + Idempotent)
✅ 3.1 health.py
...
If exists in Redis → return stored response
...
🧱 4️⃣ Dependency Injection Layer
